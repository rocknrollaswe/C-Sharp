...
namespace Uppgift1b
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Du har angett talen {input1} och {input2}. Nu ska vi multiplicera!");
            int resultat = tal1 * tal2; 
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine($"Produkten av multiplikationen är: {resultat}!"); 
